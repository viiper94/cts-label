...
$(document).ready(function () {
  ...
  $(document).on('click', '.to-clipboard', function () {
    var toCopy = $(this).html();
    console.log(toCopy);
    copy_to_clipboard__WEBPACK_IMPORTED_MODULE_0___default()(toCopy);
    $('main').append(utils.getAlertToast(null, 'Скопійовано', 'text-bg-primary', 'status-toast'));
    $('.status-toast').toast('show').on('hidden.bs.toast', function (fn) {
      return $('.status-toast-review-toast').remove();
    });
  });
});
...
/***/ "./resources/js/admin/emailing.js"
/*!****************************************!*\
  !*** ./resources/js/admin/emailing.js ***!
  \****************************************/
() {
...
/***/ "./resources/js/admin/feedback.js"
/*!****************************************!*\
  !*** ./resources/js/admin/feedback.js ***!
  \****************************************/
() {
...
$(document).ready(function () {
  ...
  $(document).on('change', '.edit-feedback .tracks input[type=file]', function (e) {
    ...
    var sizeMb = Math.floor(size / 1000000);
    var perc = sizeMb / 100 * 100;
    $('.edit-feedback .progress-bar').css({
      'width': perc + '%'
    }).find('.current').text(sizeMb);
  });
  ...
  $(document).on('click', '.mark-accepted-btn, .decline-btn', function () {
    ...
    var target = $('#editReviewModal').data('target');
    ...
    $.ajax({
      ...
      complete: function complete() {
        ...
        $('.save-review-toast').toast('show').on('hidden.bs.toast', function (fn) {
          return $('.save-review-toast').remove();
        });
      }
    });
  });
  function getResultItem(route, target) {
...
(function () {
  ...
  function getAlertToast() {
    ...
    var toastHeader = headingMessage ? '        <div class="toast-header ' + headingClass + '">\n' + '            <strong class="me-auto">' + headingMessage + '</strong>\n' + '            <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>\n' + '        </div>\n' : '';
    var toastBodyClass = 'toast-body ' + (toastHeader !== '' ? '' : headingClass);
    var toastBody = bodyMessage ? '        <div class="' + toastBodyClass + '">\n' + bodyMessage + '        </div>\n' : '';
    return '<div class="toast alert-toast align-items-center position-fixed border-0 m-3 top-0 end-0 ' + toastClass + '" ' + 'role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="3000">\n' + toastHeader + toastBody + '    </div>';
  }
  function spinner() {
    var _props$class, _props$wrapperClass;
    var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var spinnerClass = (_props$class = props["class"]) !== null && _props$class !== void 0 ? _props$class : '';
    var wrapperClass = (_props$wrapperClass = props.wrapperClass) !== null && _props$wrapperClass !== void 0 ? _props$wrapperClass : '';
    var wrapper = !!props.wrapper;
    var html = '<div class="spinner-border ' + spinnerClass + '" role="status"></div>';
    if (wrapper) {
...
$(document).ready(function () {
  ...
  $('#trackSearchModal input[name=search]').keyup(function () {
    ...
    if (query.length > 3) {
      $.ajax({
        ...
        beforeSend: function beforeSend() {
          $('#trackSearchModal').find('.search-items').before(utils.spinner({
            wrapper: true
          }));
        },
        success: function success(response) {
  ...
  $(document).on('click', '.remove-track', function () {
    if (confirm($(this).data('alert'))) $(this).parents('tr').remove();else return false;
  });
    ...
    serviceSortable[index] = Sortable.create(el, {
      ...
      onUpdate: function onUpdate(event, ui) {
        ...
        $.ajax({
          ...
          beforeSend: function beforeSend() {
            $box.parents('.service-lang').find('.msg').removeClass('text-success').html(utils.spinner({
              "class": 'spinner-border-sm'
            }));
          },
          success: function success(response) {
...
$(document).ready(function () {
  ...
  $(document).on('click', '.save-review', function () {
    ...
    $.ajax({
      ...
      success: function success(response) {
        $('main').append(utils.getAlertToast(null, response.message, 'text-bg-success', 'save-review-toast'));
        response.target === 'tracks' ? loadTrackReviewsToModal(response.url) : getResultItem(response.url, response.target, response.key);
        $('#editReviewModal').modal('hide');
      },
      error: function error(xhr) {
        $('main').append(utils.getAlertToast(null, xhr.responseJSON.message, 'text-bg-danger', 'save-review-toast'));
  ...
  $(document).on('keyup', '#json_raw', function () {
    ...
    if (!isrc) return;
    var match = (json.results || []).find(function (track) {
        ...
        reviewsSortable[index] = Sortable.create(el, {
          ...
          onUpdate: function onUpdate(event, ui) {
            ...
            $.ajax({
              ...
              complete: function complete() {
                $('.sort-toast').toast('show').on('hidden.bs.toast', function (fn) {
                  return $('.sort-toast').remove();
                });
              }
            });
          }
...
/* harmony import */ var bootstrap_star_rating__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! bootstrap-star-rating */ "./node_modules/bootstrap-star-rating/js/star-rating.min.js");
/* harmony import */ var bootstrap_star_rating__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(bootstrap_star_rating__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _admin_helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./admin/helpers */ "./resources/js/admin/helpers.js");
/* harmony import */ var _admin_helpers__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_admin_helpers__WEBPACK_IMPORTED_MODULE_3__);
...
window.Litepicker = (__webpack_require__(/*! litepicker */ "./node_modules/litepicker/dist/litepicker.umd.js").Litepicker);
...
/*!*******************************!*\
  ...
  \*******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var floating_scroll_dist_jquery_floatingscroll_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! floating-scroll/dist/jquery.floatingscroll.min */ "./node_modules/floating-scroll/dist/jquery.floatingscroll.min.js");
/* harmony import */ var floating_scroll_dist_jquery_floatingscroll_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(floating_scroll_dist_jquery_floatingscroll_min__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var bootstrap_star_rating__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! bootstrap-star-rating */ "./node_modules/bootstrap-star-rating/js/star-rating.min.js");
...
__webpack_require__(/*! ./public/common.js */ "./resources/js/public/common.js");
...
__webpack_require__(/*! ./admin/emailing.js */ "./resources/js/admin/emailing.js");
__webpack_require__(/*! ./admin/tracks.js */ "./resources/js/admin/tracks.js");
__webpack_require__(/*! ./admin/artists.js */ "./resources/js/admin/artists.js");
})();
