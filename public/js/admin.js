...
$(document).ready(function () {
  var clipboard = new (clipboard__WEBPACK_IMPORTED_MODULE_0___default())('.copy-link');
...
$(document).ready(function () {
  ...
  $('.service-lang .service-img, .service-lang .teacher button').click(function () {
    var _$$attr;
    $('#serviceModal').find('#preview').attr('src', (_$$attr = $(this).attr('src')) !== null && _$$attr !== void 0 ? _$$attr : $(this).data('src'));
