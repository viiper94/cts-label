...
var FeedbackPlayer = /*#__PURE__*/function () {
  ...
  return _createClass(FeedbackPlayer, [{
...
/***/ "./resources/js/public/artists.js"
/*!****************************************!*\
  !*** ./resources/js/public/artists.js ***!
  \****************************************/
() {
...
$(document).ready(function () {
  ...
  $(document).on('click', '.remove-artist-info-btn', function () {
    ...
    if ($('tr[data-info-id]').length === 0) $('tr.no-artists').show();else return false;
  });
...
/***/ "./resources/js/public/feedback.js"
/*!*****************************************!*\
  !*** ./resources/js/public/feedback.js ***!
  \*****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _feedback_player__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../feedback_player */ "./resources/js/feedback_player.js");
// Feedback
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        $(response.tracks).each(function (key, params) {
          window.players.push(new _feedback_player__WEBPACK_IMPORTED_MODULE_0__.FeedbackPlayer(params));
        });
      },
...
/***/ "./resources/js/public/releases.js"
/*!*****************************************!*\
  !*** ./resources/js/public/releases.js ***!
  \*****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _release_player__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../release_player */ "./resources/js/release_player.js");
// Releases
...
$(document).ready(function () {
  ...
  $('button[data-track-id]').click(function () {
    ...
    var releaseId = button.data('release-id');
    var isDifferentTrack = trackId !== $('.preview-player').data('track');
    if (isDifferentTrack) {
      ...
      $.ajax({
        url: "/releases/track/".concat(trackId, "/").concat(releaseId),
        success: function success(response) {
          if (window.player !== undefined) {
            window.player.stopPlayer();
          }
          $('main').append(response.html);
          window.player = new _release_player__WEBPACK_IMPORTED_MODULE_0__.ReleasePlayer({
          ...
          window.player.player.setVolume(volume !== null && volume !== void 0 ? volume : 0.7);
        },
        error: function error(xhr) {
          console.log('error');
        }
...
function calculateTracklistWidth() {
  var $wrapper = $('.release-info-wrapper');
  var $tracklist = $('.release-tracklist');
  var tracklistTop = $tracklist.offset().top;
  var $content = $('.release-content-wrapper');
  ...
  if (contentBottom < tracklistTop + 10) {
    ...
    var tracklistLeft = $tracklist.offset().left;
    var padding = tracklistLeft - wrapperLeft;
...
var ReleasePlayer = /*#__PURE__*/function () {
  ...
  return _createClass(ReleasePlayer, [{
    key: "updateTime",
...
/*!*****************************!*\
  ...
  \*****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var scrolltofixed_jquery_scrolltofixed__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! scrolltofixed/jquery-scrolltofixed */ "./node_modules/scrolltofixed/jquery-scrolltofixed.js");
/* harmony import */ var scrolltofixed_jquery_scrolltofixed__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(scrolltofixed_jquery_scrolltofixed__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var readmore_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! readmore-js */ "./node_modules/readmore-js/readmore.js");
/* harmony import */ var readmore_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(readmore_js__WEBPACK_IMPORTED_MODULE_1__);
...
__webpack_require__(/*! ./public/artists.js */ "./resources/js/public/artists.js");
...
__webpack_require__(/*! ./public/about.js */ "./resources/js/public/about.js");
__webpack_require__(/*! ./public/event.js */ "./resources/js/public/event.js");
})();
