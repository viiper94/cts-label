...
return [
    ...
    'about_text_3' => 'CTSchool работает напрямую с производителями и поставщиками SOFT & HARDWARE. Все программное обеспечение в вышеуказанном списке – лицензионное.',
    'about_text_4' => 'В CTSchool у вас есть возможность пройти курс обучения работе с электронной танцевальной музыкой в PROTOOLS HD 3 Accel System на MAC OS. 
                        CTSchool тесно сотрудничает с компаниями A&T Trade и МУЗТОРГ, проводит совместные акции, семинары, мастер-классы.',
    'about_text_5' => 'Стоимость курса зависит от количества занятий. Курсы разрабатываются индивидуально в зависимости от задач и опыта студентов. Одно занятие – 2 академических часа.',
    'about_text_6' => 'Первое ознакомительное занятие-собеседование бесплатно.',
    ...
    'course_edited' => 'Курс успешно отредактирован!',
    'course_deleted' => 'Курс успешно удален!',
    'teacher_added' => 'Преподаватель успешно добавлен!',
    'teacher_edited' => 'Преподаватель успешно отредактирован!',
