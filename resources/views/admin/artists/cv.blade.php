...
@section('title')
    @lang('artists.cv') | @lang('shared.admin.cts_admin_panel')
@endsection
...
@section('admin-content')
    ...
    <div class="container-fluid">
        <div class="releases-actions my-3">
            <a href="{{ route('artists.cv') }}" target="_blank" class="btn btn-outline">
                <i class="fa-solid fa-arrow-up-right-from-square me-2"></i>@lang('artists.artists_cv_page')
            </a>
        </div>
