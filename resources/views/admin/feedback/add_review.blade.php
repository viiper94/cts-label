...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-outline-success mark-accepted-btn" data-action="1" data-url="{{ route('feedback.result.modify', $result->id) }}">
        <i class="fa-solid fa-circle-check me-2"></i>@lang('feedback.replies.mark_accepted')
    </button>
    <button type="button" class="btn btn-outline-danger decline-btn" data-action="2" data-url="{{ route('feedback.result.modify', $result->id) }}">
