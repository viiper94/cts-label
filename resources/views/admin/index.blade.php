...
@section('admin-content')
    ...
    <div class="container-fluid">
        ...
        <div class="releases">
            ...
            <a href="{{ route('releases.index') }}" class="btn btn-info"><span class='glyphicon glyphicon-list'></span> Все релизы</a>
            <a href="{{ route('releases.create') }}" class="btn btn-success"><span class='glyphicon glyphicon-plus'></span> Новый релиз</a>
        ...
        <div class="artists">
            ...
            <a href="{{ route('artists.index') }}" class="btn btn-info"><span class='glyphicon glyphicon-list'></span> Все артисты</a>
            <a href="{{ route('artists.create') }}" class="btn btn-success"><span class='glyphicon glyphicon-plus'></span> Новый артист</a>
            <div class="items-container">
