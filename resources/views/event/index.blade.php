    ...
    <div class="container event py-5">
        ...
        <div class="row mb-5 py-5">
            ...
            <p class="mx-auto" style="max-width: 800px">
                <i class="fa-solid fa-calendar-days me-3"></i>Дата проведення: <b>21 лютого</b>, початок о <b>18:00</b> за київським часом.
            </p>
            <p class="mb-0 mx-auto" style="max-width: 800px">
                <i class="fa-solid fa-hourglass-end me-3"></i>Тривалість 2 години.</p>
        </div>
            ...
            <div class="card text-bg-dark speaker border-0 mb-5">
                <div class="row g-0">
                    ...
                    <div class="col-8 col-md-9 card-body d-flex flex-column">
                        ...
                        <p>Арт менеджерка, співзасновниця рекорд лейблу та студії звукозапису CTS Records і школи
                            звукорежисури CTSchool, лекторка, експертка сфери музичного маркетингу та менеджменту.</p>
                    </div>
                </div>
            </div>
