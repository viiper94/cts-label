        ...
        <div class="row" style="padding:0 17px;">
            ...
            <div class="col-xs-12 col-md-5" >
                ...
                <div class="text-right switch-btns">
                    <button class="switch-btn pull-right active" toggle="en">@lang('releases.en')</button>
                    @if($release->description_ru)
                        <button class="switch-btn pull-right" toggle="ru">@lang('releases.ru')</button>
                    @endif
                    @if($release->description_ua)
                        <button class="switch-btn pull-right" toggle="ua">@lang('releases.ua')</button>
                    @endif
                </div>
            </div>
