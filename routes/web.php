...
Route::group(['middleware' => 'i18n'], function(){
    ...
    Route::group(['middleware' => 'admin', 'namespace' => 'Admin', 'prefix' => '/cts-admin'], function(){
        ...
        Route::get('/releases/export', [AdminReleasesController::class, 'export']);
        ...
        Route::post('/feedback/results/add/{result}', [AdminFeedbackResultController::class, 'add'])->name('feedback.results.add');
        ...
        Route::post('/feedback/results/item/{result}', [AdminFeedbackResultController::class, 'getFeedbackResultItem'])->name('feedback.results.getItem');
